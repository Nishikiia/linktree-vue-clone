  ...
  >
    ...
    <div class="min-w-0 flex-1">
      ...
      <p class="truncate text-sm text-gray-400">
        Lorem ipsum dolor sit amet onsectatur adispicitng alt. Reiciendis natus aliquid laudantium.
      </p>
    </div>

    <!-- Hover Glow Effect-->
    <div
      class="absolute inset-0 rounded-xl bg-linear-to-r from-green-500/0 via-green-500/10 to-green-500/0 opacity-0 transition-opacity group-hover:opacity-100"
    />
  </a>
</template>
